...
# Please review code below as modifications are likely necessary for individual users based on differing inputs
...
# Code as currently written uses a national, merged set of NHDPlus waterbodies. This python code could be modified to pull
# waterbodies from individual NHDPlus regions
...
## Convert national waterbody to a layer
